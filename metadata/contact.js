const productMeta = {
    title: 'Contacto | Lo más selecto de las mejores marcas para el mercado hospitalario.',
    meta: [
        ...
        { hid: 'og-title', name: 'og:title', content: 'Contacto | Lo más selecto de las mejores marcas para el mercado hospitalario.' },
        { hid: 'og-type', name: 'og:type', content: 'website' },
        { hid: 'og-url', name: 'og:url', content: `https://www.dimedicalcorporativo.mx/contact` },
